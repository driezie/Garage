    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <a href="index.php" class="container__button">Plan onderhoudsbeurt</a>
        ...
        <div class="container">
            ...
            <a class="btn btn-primary" href="index.php" role="button">Plan een kleine beurt</a>
        </div>
        ...
        <div class="container">
            ...
            <a class="btn btn-primary" href="index.php" role="button">Plan een grote beurt</a>
        </div>
