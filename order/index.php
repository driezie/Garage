        ...
        <?php } elseif (($_GET['step'] == 4)) { ?>
            ...
            <div class="col-12 col-lg-7">
                ...
                <div class="form-row">
                    ...
                    <input min="<?= date('Y-m-d') ?>" type="text" class="datepicker" id="txtdate" value="Select Date Here"/>
                </div>
            ...
            <div class="form-row">
                <button type="submit" name="order_step_3" class="btn btn-primary">Create appointment</button>
            </div>
    </div>
<?php } ?>
<!-- Einde step 4 -->
